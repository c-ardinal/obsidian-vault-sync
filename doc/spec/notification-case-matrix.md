...
| `📝 [競合] マージ中: {file}`                                                                                            |    -     |     -      |    -     |      -       |     -      |     -      |          -           |      -       |      表示      |      表示      |  -   |      -       |      -       |
| `⚠️ [競合] マージロックが失効しました。ローカルに保存済み、次回同期でプッシュします。: {file}`                          |    -     |     -      |    -     |      -       |     -      |     -      |          -           |      -       |      表示      |      表示      |  -   |      -       |      -       |
...
| `⌛️ [競合] 他デバイスが解決するのを待機しています...: {file} ({N}s)`                                                    |    -     |     -      |    -     |      -       |     -      |     -      |          -           |      -       |      表示      |      表示      |  -   |      -       |      -       |
...
| `✅ [E2EE] 移行完了！`                                                                                                  |    -     |     -      |   表示   |      -       |     -      |     -      |          -           |      -       |       -        |       -        |  -   |      -       |      -       |
| `❌ [E2EE] 移行失敗`                                                                                                    |    -     |     -      |   表示   |      -       |     -      |     -      |          -           |      -       |       -        |       -        |  -   |      -       |      -       |
| `🔒 [E2EE] Vaultがロック中のため同期を一時停止しています。コマンドパレットから「E2EE: ロック解除」を実行してください。` |   表示   |    表示    |   表示   |     表示     |    表示    |    表示    |         表示         |     表示     |       -        |       -        |  -   |      -       |      -       |
