...
export const i18n: Record<string, Record<string, string>> = {
    en: {
        ...
        settingStartupDelay: "Startup Delay",
        settingStartupDelayDesc: "Wait for Obsidian to index files before syncing (0-600s)",
        settingAutoSyncInterval: "Auto-sync Interval",
        settingAutoSyncIntervalDesc:
            "Sync periodically in background. Note: To prevent data loss, sync is skipped while you are actively editing.",
        settingTriggerSave: "Trigger: Save [Ctrl+S]",
        settingTriggerSaveDesc: "Sync when you explicitly save a file",
        settingModify: "Modify Delay",
        settingModifyDesc: "Seconds of inactivity before syncing. Set to -1 to disable.",
        settingTriggerLayout: "Trigger: Layout Change Delay",
        settingTriggerLayoutDesc: "Sync delay after switching files/tabs. Set to -1 to disable.",
        settingPerfSection: "Performance",
        settingConcurrency: "Concurrency",
        settingConcurrencyDesc: "Max concurrent file uploads/downloads (1-10)",
    ...
    ja: {
        ...
        settingConcurrencyDesc: "並列で実行するファイルのアップロード/ダウンロード数。",
