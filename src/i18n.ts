...
export const i18n: Record<string, Record<string, string>> = {
    en: {
        ...
        noticeSyncing: "Syncing: Processing start...",
        ...
        waitOtherDeviceMerge: "💤 [Conflict] Waiting for other device to resolve...",
        ...
        noticeSafetyMerge: "🛡️ [Sync] Protective merge...",
        ...
        noticeFileRestored: "✅ [History] File restored. Syncing changes...",
        noticeHistoryRestoreAs: "✅ [History] File created as {0}",
    ...
    ja: {
        ...
        noticeWaitingForRemoteRegistration: "💤 [同期] リモート側の反映完了を待機中...",
